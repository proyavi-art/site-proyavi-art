...
export default function Uslugi() {
  ...
  return (
    <div className="min-h-screen bg-[#80AEBA] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-xl bg-[#F0F0DA] rounded-2xl p-8 md:p-12 shadow-[0_25px_45px_rgba(0,0,0,0.2)] border border-[rgba(212,175,55,0.4)]">
        <Link
          href="/"
          className="inline-block mb-6 text-gray-600 hover:text-black transition-colors text-sm font-medium"
        >
          ← Вернуться на главную
        </Link>

        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Заявка на ProЯвление</h1>
