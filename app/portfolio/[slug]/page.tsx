...
Как правило, чем старше фотография, тем больше деталей утрачено — из-за времени и несовершенства технологий прошлого. Но даже спустя десятилетия что-то всё ещё можно вернуть.`,
  ...
  places: {
    ...
    description: `Путешествия и события сохраненые в ваших фотоархивах. Верните в своих воспоминаниях с помощью наших возможностей.`,
    caption: `С разрешения наших заказчиков, мы публикуем данные примеры выполненных нами работ.`,
    works: [
      {
      ...
      },
      {
        ...
        desc: `Переправа через реку. Карпаты. 1972 год.`,
        note: `Фотографи более 50 лет. За это время к некачаственной проявке и недостаточной выдержке, добавились деффеты ввиде пятен пролитой жидкости и механические повреждения. Мы очистили момент от шума и вернули свет.`,
        review: ``,
      },
    ],
  },
