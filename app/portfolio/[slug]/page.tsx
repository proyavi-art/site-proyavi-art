  ...
  places: {
    ...
    works: [
      ...
      },
      {
        ...
        note: `Фотографи более 50 лет. За это время к некачаственной проявки и недостаточной выдержке добавились дефеты в виде пятен пролитой жидкости и механические повреждения. Мы очистили момент от шума и вернули свет.`,
        review: ``,
      },
    ],
  },
